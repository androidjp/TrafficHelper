...
public class DemoPresenter implements DemoContract.Presenter, RecognitionListener {

    private Context mContext;
    private WeakReference<DemoContract.View> mView;
    ///相关参数
    ...
    public DemoPresenter(Context context, DemoContract.View view) {
        mContext = context;
        mView = new WeakReference<DemoContract.View>(view);
    }
